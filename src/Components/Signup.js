    ...
    return (
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '100vh' }}>
            <Grid container>
                ...
                <Grid item xs={12} sm={4} sx={{ p: 6, background: 'rgba(0, 116, 144, 1)', borderRadius: 2, boxShadow: '10px 3px 8px rgba(0,0,0,.15)' }}>
                        ...
                        <Grid container spacing={2} className="signup-details">
                            <Grid item xs={6}>
                                ...
                                <TextField
                                    ...
                                    sx={{
                                        ...
                                        '& .MuiInputBase-input': { padding: '12px 14px' }, // Adjust padding if needed
                            ...
                            <Grid item xs={12} sx={{ textAlign: 'center' }}>
                                <Typography sx={{ color: '#F2F2F2' }}>
                                    Already have an account? <Link to="/login" style={{ color: '#FFFFFF', fontWeight: 'bold' }}>Sign In</Link>
                                </Typography>
                            </Grid>
                        </Grid>
                    </form>
