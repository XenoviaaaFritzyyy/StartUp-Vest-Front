...
import { Grid, Typography, TextField, Button, Select, MenuItem, FormControl, InputLabel } from '@mui/material';
                ...
                <form onSubmit={handleSubmit} className='signup-form'>
                    <Grid container spacing={2} className="signup-details">
                        ...
                        <Grid item xs={12}>
                            ...
                            <TextField fullWidth name="password" placeholder="Example123" type="password" required sx={{background: '#F2F2F2', borderRadius: 1}}/>
                        </Grid>
                        ...
                        <Grid item xs={12} sx={{textAlign: 'center'}}>
                            <Typography variant="h7" sx={{ color: '#F2F2F2' }}>
                                Already have an account? <Link to="/" component="span">Sign In</Link>
                            </Typography>
                        </Grid>
                    </Grid>
                </form>
